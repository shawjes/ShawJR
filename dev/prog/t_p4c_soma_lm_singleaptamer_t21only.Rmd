...
##### Model C: Zlog10_relative_abundance ~ Age + Female (T21s only)
###### Hypotheses tested by model:
- Difference in the mean value of Zlog10_relative_abundance for each 1 year increase in age at blood draw (i.e., the slope for age), among T21s only.
- Difference in the group mean of Zlog10_relative_abundance for female T21s as compared to male T21s.
...
modelc: Zlog10_relative_abundance ~ Age + Female (T21s only)
```{r}
