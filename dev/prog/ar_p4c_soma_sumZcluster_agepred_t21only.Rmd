...
#### ar_p4c_soma_sumZcluster_agepred_t21only
```{r}
ar_p4c_soma_sumZcluster_agepred_t21only <- ai_p4c_soma %>%
...
```{r}
setwd(dir.ardata)
fwrite(ar_p4c_soma_sumZcluster_agepred_t21only,
       "ar_p4c_soma_sumZcluster_agepred_t21only.csv.gz")
```