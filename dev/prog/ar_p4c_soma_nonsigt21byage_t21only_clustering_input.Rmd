...
```{r}
ar_p4c_soma_nonsigt21byage_t21only_clustering_input <- t_p4c_soma_lm_singleaptamer_tidy %>%
...
setwd(dir.ardata)
fwrite(ar_p4c_soma_nonsigt21byage_t21only_clustering_input, "ar_p4c_soma_nonsigt21byage_t21only_clustering_input.csv.gz")
```
