...
```{r}
setwd(dir.ddata)
fwrite(lm_vif, "t_p4f_soma_lm_singlecluster_d21only_vif.csv.gz")
fwrite(lm_tidy, "t_p4f_soma_lm_singlecluster_d21only_tidy.csv.gz")
fwrite(lm_augment, "t_p4f_soma_lm_singlecluster_d21only_augment.csv.gz")
fwrite(lm_glance, "t_p4f_soma_lm_singlecluster_d21only_glance.csv.gz")
```